...
public class DateUtils {
     ...
     */
    public static Date string2Date(String dateString, SimpleDateFormat DFM) throws ParseException {
     ...
     * @return
     */
    public static String date2String(Date date,SimpleDateFormat DFM) {
    ...
    public static void main(String[] args) {
        try {
            System.out.println(parseDate2String(getLastDayOfMonth(new Date())));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
